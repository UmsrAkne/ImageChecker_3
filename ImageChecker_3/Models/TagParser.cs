    ...
    public class TagParser
    {
        ...
        public static ImageTag LoadImageTag(string input)
        {
            ...
            if (Regex.IsMatch(input, tagPattern))
            {
                ...
                result.Scale = float.Parse(attributes.GetValueOrDefault("scale", "1.0"));
            }
            else
            {
                System.Diagnostics.Debug.WriteLine($"タグの形式が正しくありません (TagParser : 47)");
            }
